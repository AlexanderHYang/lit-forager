import{g as e}from"./index-c34e7bd4.js";const t="prePassDeclaration",a=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]=f;const s="shadowsFragmentFunctions",d=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[s]=d;const n="samplerFragmentDeclaration",l=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[n]=l;const h="reflectionFunction",v=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[h]=v;const p="bumpFragmentMainFunctions",u=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[p]=u;const c="bumpFragmentFunctions",m=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[c]=m;const S="bumpFragment",w=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[X]=D;const T="lightFragment",L=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[T]=L;const I="oitFragment",C=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
