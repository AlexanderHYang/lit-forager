import{g as e}from"./index-c34e7bd4.js";import"./oitFragment-BQIEcNub-85dcaad5.js";import"./harmonicsFunctions-BqFFoz13-3a8b64b3.js";import"./mainUVVaryingDeclaration-B3QYkxw_-2840ff16.js";import"./imageProcessingFunctions-HfmLj6xz-dc9e8ab7.js";import"./hdrFilteringFunctions-DZRf3k9A-4edcc673.js";const a="pbrFragmentDeclaration",r=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[M]=D;const _="pbrBlockAlphaFresnel",F=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[_]=F;const h="pbrBlockAnisotropic",P=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[h]=P;const U="pbrBlockReflection",b=`#ifdef REFLECTION
...
return outParams;}
#endif
`;e.IncludesShadersStore[W]=X;const Y="pbrBlockNormalGeometric",k=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[Y]=k;const w="pbrBlockNormalFinal",z=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;e.IncludesShadersStore[w]=z;const K="pbrBlockLightmapInit",q=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[K]=q;const Z="pbrBlockGeometryInfo",J=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[Z]=J;const j="pbrBlockReflectance0",Q=`float reflectance=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);vec3 specularEnvironmentR0=reflectivityOut.surfaceReflectivityColor.rgb;
#ifdef METALLICWORKFLOW
...
#endif
`;e.IncludesShadersStore[j]=Q;const $="pbrBlockReflectance",ee=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[$]=ee;const ie="pbrBlockDirectLighting",ne=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SPECULARTERM
