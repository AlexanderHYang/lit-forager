import{g as e}from"./index-c34e7bd4.js";import"./oitFragment-B051QTBm-6cfd2535.js";import"./harmonicsFunctions-D33SlHEa-25487b22.js";import"./mainUVVaryingDeclaration-C4YOsoau-2bfc68f5.js";import"./logDepthFragment-BqJ6p4j0-90d7e971.js";import"./logDepthDeclaration-CrLeLjnO-985c7b59.js";import"./hdrFilteringFunctions-7ZTtGdKp-5bd2d8da.js";const a="pbrFragmentExtraDeclaration",n=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[w]=z;const K="pbrBlockGeometryInfo",q=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[K]=q;const Z="pbrBlockReflectance0",J=`var reflectance: f32=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);var specularEnvironmentR0: vec3f=reflectivityOut.surfaceReflectivityColor.rgb;
#ifdef METALLICWORKFLOW
...
#endif
`;e.IncludesShadersStoreWGSL[Z]=J;const j="pbrBlockReflectance",Q=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[j]=Q;const $="pbrBlockDirectLighting",ee=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;e.IncludesShadersStoreWGSL[$]=ee;const ie="pbrBlockFinalLitComponents",re=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
}`;e.ShadersStoreWGSL[i]=r;const Ce={name:i,shader:r};export{Ce as pbrPixelShaderWGSL};
