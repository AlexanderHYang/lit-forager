import{g as e}from"./index-c34e7bd4.js";import"./defaultUboDeclaration-DgPVw5_q-fa503db4.js";import"./oitFragment-B051QTBm-6cfd2535.js";import"./mainUVVaryingDeclaration-C4YOsoau-2bfc68f5.js";import"./logDepthFragment-BqJ6p4j0-90d7e971.js";import"./logDepthDeclaration-CrLeLjnO-985c7b59.js";const o="lightsFragmentFunctions",i=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
#endif
return result;}
fn computeProjectionTextureDiffuseLighting(projectionLightTexture: texture_2d<f32>,projectionLightSampler: sampler,textureProjectionMatrix: mat4x4f,posW: vec3f)->vec3f {var strq: vec4f=textureProjectionMatrix*vec4f(posW,1.0);strq/=strq.w;var textureColor: vec3f=textureSample(projectionLightTexture,projectionLightSampler,strq.xy).rgb;return textureColor;}`;e.IncludesShadersStoreWGSL[o]=i;const a="fresnelFunction",n=`#ifdef FRESNEL
fn computeFresnelTerm(viewDirection: vec3f,worldNormal: vec3f,bias: f32,power: f32)->f32
{let fresnelTerm: f32=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStoreWGSL[a]=n;const r="defaultPixelShader",f=`#include<defaultUboDeclaration>
...
`;e.ShadersStoreWGSL[r]=f;const v={name:r,shader:f};export{v as defaultPixelShaderWGSL};
